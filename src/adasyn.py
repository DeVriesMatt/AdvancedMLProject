...
for filename in os.listdir(matlab_path):
        ...
        y_res_pd.to_csv(oversampled + filename + "_smote.csv")
        ...
        y_res_pd_ada.to_csv(oversampled + filename + "_adasyn.csv")
...
# print("X train shape: {}".format(X_train.shape))
#
# # Perform SMOTE firstly on only the raw training set
# sm = SMOTE(random_state=42)
# X_res, y_res = sm.fit_resample(X_train, y_train)
#
# y_res_pd = pd.DataFrame(y_res)
# print("The value counts for the training set after SMOTE:")
# print(y_res_pd.sum(axis=0))
# y_res_pd.to_csv(oversampled + "kaggle_smote_train.csv")
#
# # Perform Adasyn firstly on only the raw training set
#
# ada = ADASYN(random_state=42)
# X_res_ada, y_res_ada = ada.fit_resample(X_train, y_train)
#
...
# print("The value counts for the whole dataset after ADASYN:")
# print(y_res_pd_ada.sum(axis=0))
# y_res_pd_ada.to_csv(oversampled + "kaggle_adasyn_train.csv")
#
